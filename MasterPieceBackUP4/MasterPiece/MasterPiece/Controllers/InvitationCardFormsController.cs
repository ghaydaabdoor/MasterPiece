...
namespace MasterPiece.Controllers
{
    public class InvitationCardFormsController : Controller
    {
        ...
        // GET: InvitationCardForms/Details/5
        ...
        //// GET: InvitationCardForms/Edit/5
        ...
        // POST: InvitationCardForms/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public ActionResult Edit([Bind(Include = "InvitationCardFormId,OrderId,UserId,CardDesignId,GroomName,BrideName,WeddingDate,Venue,AdditionalNotes,Status")] InvitationCardForm invitationCardForm)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        db.Entry(invitationCardForm).State = EntityState.Modified;
        //        db.SaveChanges();
        //        return RedirectToAction("Index");
        //    }
        //    ViewBag.CardDesignId = new SelectList(db.InvitationCards, "InvitationCardsId", "CardName", invitationCardForm.CardDesignId);
