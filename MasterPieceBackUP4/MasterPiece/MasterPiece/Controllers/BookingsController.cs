    ...
    public class BookingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookingId,UserId,FullName,Email,Phone,BookingDate,BookingTimeFrom,SpecialOrder,IsApproved,BookingTimeTo,VenueId")] Booking booking)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Create", "Bookings");  // Redirect to a different page on successful booking.
            }
        ...
        public ActionResult CreateFarmForm([Bind(Include = "BookingId,UserId,FullName,Email,Phone,BookingDate,BookingTimeFrom,SpecialOrder,IsApproved,BookingTimeTo,FarmId")] Booking booking)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["BookingSuccess"] = "تم حجزك بنجاح";
                TempData.Keep("BookingSuccess");
                return RedirectToAction("CreateFarmForm", "Bookings");
            }
        ...
        public ActionResult ProcessPaymentVenue(int bookingId, int venueId, decimal value)
        {
            ...
            string redirectUrl = Url.Action("PaymentSuccess", "Payment", new { bookingId, venueId }, protocol: Request.Url.Scheme);
            string cancelUrl = Url.Action("PaymentCancel", "Payment", new { bookingId, venueId }, protocol: Request.Url.Scheme);
        ...
        {
            return RedirectToAction("Index", "Home"); // Redirect to the homepage or booking page
        }

        public ActionResult CloseTabVenue()
        {
            return View();
        }
        ...
        public ActionResult ProcessPaymentFarm(int bookingId, int farmId, decimal value)
        {
            ...
            // Define the redirect URLs for success and cancellation
            string redirectUrl = Url.Action("PaymentSuccess", "Payment", new { bookingId, farmId }, protocol: Request.Url.Scheme);
            string cancelUrl = Url.Action("PaymentCancel", "Payment", new { bookingId, farmId }, protocol: Request.Url.Scheme);
        ...
        public ActionResult CloseTabFarm()
        {
            return View();
        }
